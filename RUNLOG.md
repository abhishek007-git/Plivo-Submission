...
- **Conclusion:** ⚠️ conditional keep. Tying alone is a small regression here, but the point is the freed 327k-param budget. HARD CHECKPOINT: the capacity retune (Run 6) must beat the untied 2.0434, else revert tying. Cheap param-neutral wins (grad clip, scaled init) run first.
